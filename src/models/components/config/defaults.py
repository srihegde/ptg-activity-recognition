...
_C.MODEL.HEAD.REGRESSION_HEADS = [
    ["2d_dim"],
    ["3d_offset"],
    ["3d_dim"],
    ["ori_cls", "ori_offset"],
...
_C.MODEL.HEAD.REGRESSION_CHANNELS = [
    [
        4,
    ],
    [
...
_C.MODEL.HEAD.DIMENSION_MEAN = (
    (3.8840, 1.5261, 1.6286),
...
_C.MODEL.HEAD.DIMENSION_STD = (
    (0.4259, 0.1367, 0.1022),
