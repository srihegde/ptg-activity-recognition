...
class _NumPointsInGTCalculater:
    ...
    def __init__(
        self, data_path, relative_path, remove_outside=True, num_features=4, num_worker=8
    ) -> None:
...
def create_waymo_info_file(
    data_path, pkl_prefix="waymo", save_path=None, relative_path=True, max_sweeps=5, workers=8
):
