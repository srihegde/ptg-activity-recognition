...
class PointRPNHead(BaseModule):
    ...
    def loss(self, bbox_preds, cls_preds, points, gt_bboxes_3d, gt_labels_3d, img_metas=None):
        ...
        semantic_loss = self.cls_loss(
            semantic_points, semantic_points_label.reshape(-1), semantic_loss_weight.reshape(-1)
        )
    ...
    def get_targets(self, points, gt_bboxes_3d, gt_labels_3d):
        ...
        (bbox_targets, mask_targets, positive_mask, negative_mask, point_targets) = multi_apply(
    ...
    def get_bboxes(self, points, bbox_preds, cls_preds, input_metas, rescale=False):
        ...
        for b in range(batch_size):
            ...
            bbox_selected, score_selected, labels, cls_preds_selected = self.class_agnostic_nms(
