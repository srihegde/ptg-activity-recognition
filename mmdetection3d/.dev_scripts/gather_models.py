...
RESULTS_LUT = {
    ...
    "scannet": ["mAP_0.50"],
    "sunrgbd": ["mAP_0.50"],
    "kitti-mono3d": ["img_bbox/KITTI/Car_3D_AP40_moderate_strict", "Car_3D_AP40_moderate_strict"],
...
def main():
    ...
    for model in model_infos:
        ...
        trained_model_path = osp.join(models_root, "epoch_{}.pth".format(model["epochs"]))
