model = dict(
    ...
    neck=dict(
        type="PointNetFPNeck",
        fp_channels=((1536, 512, 512), (768, 512, 512), (608, 256, 256), (257, 128, 128)),
    ),
    rpn_head=dict(
        type="PointRPNHead",
        num_classes=3,
        enlarge_width=0.1,
        pred_layer_cfg=dict(
            in_channels=128, cls_linear_channels=(256, 256), reg_linear_channels=(256, 256)
        ),
        cls_loss=dict(
            type="FocalLoss",
            use_sigmoid=True,
        ...
        bbox_loss=dict(type="SmoothL1Loss", beta=1.0 / 9.0, reduction="sum", loss_weight=1.0),
        bbox_coder=dict(
