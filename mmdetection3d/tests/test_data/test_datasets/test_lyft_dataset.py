...
def test_getitem():
    ...
    pipelines = [
        ...
        dict(
            type="LoadPointsFromMultiSweeps", sweeps_num=2, file_client_args=dict(backend="disk")
        ),
...
def test_show():
    ...
    eval_pipeline = [
        ...
        dict(
            type="LoadPointsFromMultiSweeps", sweeps_num=10, file_client_args=dict(backend="disk")
        ),
