...
def decode_scores(
    net, end_points, num_class, num_heading_bin, num_size_cluster, mean_size_arr, key_prefix
):
    ...
    end_points[
        key_prefix + "heading_residuals_normalized"
    ] = heading_residuals_normalized  # Bxnum_proposalxnum_heading_bin (should be -1 to 1)
    end_points[key_prefix + "heading_residuals"] = heading_residuals_normalized * (
    ...
    end_points[key_prefix + "size_residuals"] = size_residuals_normalized * torch.from_numpy(
...
class ProposalModule(nn.Module):
    ...
    def forward(self, xyz, features, end_points):
        ...
        end_points[
            self.key_prefix + "aggregated_vote_inds"
