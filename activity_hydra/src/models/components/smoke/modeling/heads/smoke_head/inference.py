import torch
from smoke.layers.utils import nms_hm, select_point_of_interest, select_topk
from smoke.modeling.smoke_coder import SMOKECoder
from torch import nn


class PostProcessor(nn.Module):
    def __init__(self, smoker_coder, reg_head, det_threshold, max_detection, pred_2d):
    ...
    def prepare_targets(self, targets):
        ...
        return dict(trans_mat=trans_mat, K=K, size=size)
    ...
    def forward(self, predictions, targets):
        ...
        pred_regression = select_point_of_interest(batch, indexs, pred_regression)
        ...
        result = torch.cat(
            [clses, pred_alphas, box2d, pred_dimensions, pred_locations, pred_rotys, scores], dim=1
        )
