...
from smoke.modeling.make_layers import _fill_fc_weights, group_norm
...
class SMOKEPredictor(nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        assert (
            sum(regression_channels) == regression
...
def make_smoke_predictor(cfg, in_channels):
    func = registry.SMOKE_PREDICTOR[cfg.MODEL.SMOKE_HEAD.PREDICTOR]
