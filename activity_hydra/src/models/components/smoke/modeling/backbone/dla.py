...
from smoke.modeling.make_layers import _fill_up_weights, _make_conv_level, group_norm
...
class IDAUp(nn.Module):
    def __init__(self, in_channels, out_channel, up_f, norm_func):  # todo: what is up_f here?
